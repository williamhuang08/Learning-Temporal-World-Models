...
def mc_kl_neighbors(curr_logits, curr_mu, curr_std, neigh_logits, neigh_mu, neigh_std):
    ...
    # 1. Sample a skill from the prior conditioned on actual s0
    ...
    # 2. Take logp of that skill
    logp = log_mog_diag(z, curr_logits, curr_mu, curr_std)

    # 3. Take logq of that skill under the neighboring states
    ...
    # 4. Calculate divergence of p from q
